...
org.eclipse.jface.dialogs.StatusDialog {
    ...
    public InclusionExclusionEntryDialog(Shell parent, boolean isExclusion,
        ...
        exclPatternStatus = new Status(IStatus.OK, FileRsyncPlugin.PLUGIN_ID,
                IStatus.OK, "", null);
    ...
    protected void checkIfPatternValid() {
        ...
        if (pattern.length() == 0) {
            exclPatternStatus = new Status(IStatus.ERROR,
                    FileRsyncPlugin.PLUGIN_ID, IStatus.OK, "Enter a pattern.",
                    null);
            return;
        }
        ...
        if (path.isAbsolute() || path.getDevice() != null) {
            exclPatternStatus = new Status(IStatus.ERROR,
                    FileRsyncPlugin.PLUGIN_ID, IStatus.OK,
