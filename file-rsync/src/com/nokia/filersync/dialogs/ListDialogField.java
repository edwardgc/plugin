...
public class ListDialogField extends DialogField {
    ...
    protected List<String> fElements;
    ...
    public ListDialogField(IListAdapter adapter, String[] buttonLabels, ILabelProvider lprovider) {
        ...
        fElements= new ArrayList<String>(10);
     ...
     * (enable state, button invocation behaviur)
     */
    ...
    public void setElements(List<String> elements) {
        fElements= new ArrayList<String>(elements);
        if (isOkToUse(fTableControl)) {
            fTable.refresh();
        }
        dialogFieldChanged();
    ...
    public List<String> getElements() {
        return new ArrayList<String>(fElements);
    }
     ...
     * Replaces an element.
     */
    public void replaceElement(Object oldElement, String newElement) throws IllegalArgumentException {
        int idx= fElements.indexOf(oldElement);
        if (idx != -1) {
            fElements.set(idx, newElement);
            if (isOkToUse(fTableControl)) {
                List<String> selected= getSelectedElements();
    ...
    public void addElements(List<String> elements) {
        ...
        if (nElements > 0) {
            // filter duplicated
            ArrayList<String> elementsToAdd= new ArrayList<String>(nElements);
     ...
     */
    public void removeElements(List<String> elements) {
        if (elements.size() > 0) {
    ...
    private List<String> moveUp(List<String> elements, List<String> move) {
        int nElements= elements.size();
        List<String> res= new ArrayList<String>(nElements);
    ...
    private void moveUp(List<String> toMoveUp) {
        if (toMoveUp.size() > 0) {
    ...
    private void moveDown(List<String> toMoveDown) {
    ...
    private List<String> reverse(List<String> p) {
        List<String> reverse= new ArrayList<String>(p.size());
